/**
 * The full curiosity page, kept unrouted.
 *
 * It lives on as the test-site preview deployment and in this file,
 * ready to become the homepage again the day it is approved for the
 * real site. Nothing imports it from a routed page on purpose.
 *
...
import { WordStorm } from "./WordStorm.tsx";
import { Paw } from "./Paw.tsx";
import { MadeBy } from "./MadeBy.tsx";
