...
export const METRICS = [
  ...
  {
    label: "Email list size worked with at Genius One",
    approved_wording: "Designed marketing emails and built and managed email marketing funnels for email lists totaling more than 100,000 contacts",
    numeric_value: 100000, unit: "contacts",
    employer: "Genius One, Inc.",
    context_note: "SCOPE: this is the size of the lists and audience the user worked with, NOT a list he personally acquired or grew, unless separately established. QUESTION: is the wording above the version you would defend, and over what period were the lists that size? Unapproved until answered.",
  },
  {
...
export const POLARITY_EVIDENCE = [
  ...
  { polarity: "POSITIVE",
    ...
    detail: "Designed marketing emails, built and managed marketing funnels, segmented audiences so different list segments received different campaigns depending on the strategy, and adapted messaging to different customer groups. SCOPE GUARDRAIL: 100,000+ is the size of the lists worked with, not a list the user personally acquired." },
